        ...
        <div className='p-8 md:p-12'>
            <div className='max-w-7xl mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
                    <div>
                        <h2 className='text-2xl font-bold mb-4'>Subscribre to My Newsletter</h2>
                        <p className='text-gray-600 dark:text-gray-300 md:w-2/3'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero est unde ab ipsam natus odit vel velit eos soluta molestiae hic quisquam possimus nemo architecto consequatur a, quis vitae. Ea.</p>
                    </div>
